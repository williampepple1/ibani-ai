    ...
    <div className="min-h-screen bg-mesh selection:bg-primary-200/50">
      ...
      <main className="container mx-auto px-4 pb-24 relative z-10">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-slate-200/50 backdrop-blur-md p-1.5 rounded-2xl flex gap-1">
            <button
        ...
        <footer className="mt-24 text-center">
          <div className="max-w-2xl mx-auto border-t border-slate-200 pt-12">
            <p className="text-slate-400 font-medium">
              Ibani Translator &bull; Empowering communication through technology
            </p>
            <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-slate-100/50 rounded-full border border-slate-200/50">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-xs font-semibold text-slate-500 uppercase tracking-widest">
                Server Status: <span className="text-slate-700">localhost:8080</span>
              </span>
            </div>
          </div>
        </footer>
